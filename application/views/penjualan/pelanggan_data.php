		...
		<div class="content-wrapper">
			...
			<section class="content">
				<div class="box box-solid bg-gray">
					<div class="box-header with-border"><h5><i class='fa fa-shopping-cart fa-fw'></i> Penjualan <i class='fa fa-angle-double-right fa-fw'></i><i class='fa fa-user fa-fw'></i> Data Pelanggan</h5></div>
